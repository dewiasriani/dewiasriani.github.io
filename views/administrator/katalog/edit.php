        <div class="row">
			<ol class="breadcrumb">
				...
				<li><a href="<?=base_url('/administrator/katalog.html')?>">Kategori</a></li>
            ...
            <div class="col-lg-6">
				<form role="form" action="" method="POST">
					<div class="form-group">
						...
						<input value="<?=$find['nama_katalog']?>" class="form-control" placeholder="..." name="nama_katalog" id="nama_katalog">
					</div>
					<div class="form-group">
						<label>SLUG</label>
						<input value="<?=$find['slug']?>" class="form-control" placeholder="...." name="slug" id="slug">
					</div>
					<div class="form-group">
