...
<header>
  <div class="headerstrip">
    <div class="container">
      <div class="row">
        <div class="span12">
          <a href="<?=base_url()?>" class="logo pull-left"><img src="<?=base_url('/assets/theme/')?>img/logo3.png" alt="SimpleOne" title="SimpleOne"></a>
          <!-- Top Nav Start -->
          <div class="pull-left">
...
<footer id="footer">
  <section class="copyrightbottom">
    <div class="container">
      <div class="row">
        <div class="span6"> Create By UNCP | Dedicated to Desa Asuli</a>
         </div>
